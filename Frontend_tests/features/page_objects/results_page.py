...
class ResultsPage(BasePage):
    ...
    LOC_ITEM_PRICE = (By.CSS_SELECTOR, "div.text-block div.info-box strong.price")
    LOC_ITEM_PROPERTY_TYPE = (By.CSS_SELECTOR, "div.info-box ul.info li:nth-of-type(1)")
    LOC_ITEM_NUMBER_OF_BEDS = (By.CSS_SELECTOR, "div.info-box ul.info li:nth-of-type(2)")
    LOC_ITEM_NUMBER_OF_BATHS = (By.CSS_SELECTOR, "div.info-box ul.info li:nth-of-type(3)")
    ...
    def _find_text_of_child_elem(self, parent, child):
        return parent.find_element(*child).text
    ...
    def get_item_property_type(self, item):
        property_type = item.find_element(*self.LOC_ITEM_PROPERTY_TYPE).text
